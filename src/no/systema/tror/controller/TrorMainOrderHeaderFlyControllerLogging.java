...
@Controller
@Scope("session")
public class TrorMainOrderHeaderFlyControllerLogging {
	private static final JsonDebugger jsonDebugger = new JsonDebugger();
	private static final Logger logger = Logger.getLogger(TrorMainOrderHeaderFlyControllerLogging.class.getName());
	 ...
	 * @return
	 */
	@RequestMapping(value="tror_mainorderfly_logging.do",  method= RequestMethod.GET)
	public ModelAndView doShowList(HttpSession session, HttpServletRequest request){
		Map model = new HashMap();
		SystemaWebUser appUser = (SystemaWebUser)session.getAttribute(AppConstants.SYSTEMA_WEB_USER_KEY);
		//String messageFromContext = this.context.getMessage("user.label",new Object[0], request.getLocale());
		ModelAndView successView = new ModelAndView("tror_mainorderfly_logging");
		logger.info("Method: doShowList [RequestMapping-->tror_mainorderfly_logging.do]");
	 ...
	 * @return
	 */
	@RequestMapping(value="tror_mainorderfly_renderEdifact.do", method={ RequestMethod.GET })
	 ...
	 * @return
	 */
	@RequestMapping(value="tror_mainorderflyimport_renderLargeText.do",  method= RequestMethod.GET)
