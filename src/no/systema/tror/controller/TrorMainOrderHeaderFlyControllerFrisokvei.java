...
@Scope("session")
public class TrorMainOrderHeaderFlyControllerFrisokvei {
	private static final Logger logger = Logger.getLogger(TrorMainOrderHeaderFlyControllerFrisokvei.class.getName());
	 ...
	 * @return
	 */
	@RequestMapping(value="tror_mainorderfly_frisokvei.do", method={RequestMethod.GET} )
	public ModelAndView doInit(@ModelAttribute ("record") JsonTrorOrderHeaderFrisokveiRecord recordToValidate, BindingResult bindingResult, HttpSession session, HttpServletRequest request){
		...
		ModelAndView successView = new ModelAndView("tror_mainorderfly_frisokvei");
	 ...
	 * @return
	 */
	@RequestMapping(value="tror_mainorderfly_frisokvei_edit.do",  method={RequestMethod.GET, RequestMethod.POST} )
	public ModelAndView doEditBudget(@ModelAttribute ("record") JsonTrorOrderHeaderFrisokveiRecord recordToValidate, BindingResult bindingResult, HttpSession session, HttpServletRequest request){
		...
		logger.info("ACTION: " + action);
		ModelAndView successView = new ModelAndView("redirect:tror_mainorderfly_frisokvei.do?action=doFind" + params.toString() );
