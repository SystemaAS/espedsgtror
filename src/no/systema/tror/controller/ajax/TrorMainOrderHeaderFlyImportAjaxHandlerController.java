...
public class TrorMainOrderHeaderFlyImportAjaxHandlerController {
	...
	private static final JsonDebugger jsonDebugger = new JsonDebugger(800);
	   ...
	   * 
	   */
		@RequestMapping(value = "getOrderInvoiceDetailLine_Flyimport.do", method = RequestMethod.GET)
		 ...
		 * @return
		 */
		@RequestMapping(value = "getCustomer_Flyimport.do", method = RequestMethod.GET)
	    public @ResponseBody Collection<JsonMaintMainCundfRecord> getCustomer
			 ...
			 logger.info("Inside: getCustomer_Flyimport");
		...
		*/
		...
		@RequestMapping(value = "validateSupplier_Flyimport.do", method = RequestMethod.GET)
	...
	/**
	   ...
	   */
		...
		@RequestMapping(value = "getBudgetDetailLine_Flyimport.do", method = RequestMethod.GET)
		...
		@RequestMapping(value = "getFrisokveiDetailLine_Flyimport.do", method = RequestMethod.GET)
		 ...
		 * @return
		 */
		@RequestMapping(value = "getTrackAndTraceGeneralDetailLine_Flyimport.do", method = RequestMethod.GET)
		 ...
		 * @return
		 */
		@RequestMapping(value = "getOppdragsTypeDocuments_Flyimport.do", method = RequestMethod.GET)
