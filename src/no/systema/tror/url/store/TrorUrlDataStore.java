...
public class TrorUrlDataStore {
	...
	//http://gw.systema.no:8080/syjservicestror/syjsLOCF.do?user=OSCAR
	static public String TROR_BASE_FETCH_LOCF_URL = AppConstants.HTTP_ROOT_SERVLET_JSERVICES + "/syjservicestror/syjsLOCF.do?";
	...
	//http://gw.systema.no:8080/syjservicestror/syjsFFR03F.do?user=OSCAR
	static public String TROR_BASE_FETCH_FFR03F_URL = AppConstants.HTTP_ROOT_SERVLET_JSERVICES + "/syjservicestror/syjsFFR03F.do?";
	...
	//http://localhost:8080/syjservicestror/syjsRATCDF.do?user=OSCAR
	static public String TROR_BASE_FETCH_RATCDF_URL = AppConstants.HTTP_ROOT_SERVLET_JSERVICES + "/syjservicestror/syjsRATCDF.do?";
