 ...
 *
 */
public class JsonTrorOrderFlyImportInvoiceRecord extends JsonAbstractGrandFatherRecord implements Comparable<JsonTrorOrderFlyImportInvoiceRecord>{
	 ...
	 */
	public int compareTo(JsonTrorOrderFlyImportInvoiceRecord record) {
		return 1;
	}
	/**
	 * 
	 ...
	 */
	public static class OrderByCodeAndInvoiceNr implements Comparator<JsonTrorOrderFlyImportInvoiceRecord> {
        @Override
        public int compare(JsonTrorOrderFlyImportInvoiceRecord o1, JsonTrorOrderFlyImportInvoiceRecord o2) {
