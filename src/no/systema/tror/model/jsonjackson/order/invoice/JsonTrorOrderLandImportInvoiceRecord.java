 ...
 *
 */
public class JsonTrorOrderLandImportInvoiceRecord extends JsonAbstractGrandFatherRecord implements Comparable<JsonTrorOrderLandImportInvoiceRecord>{
	 ...
	 */
	public int compareTo(JsonTrorOrderLandImportInvoiceRecord record) {
		return 1;
	}
	/**
	 * 
	 ...
	 */
	public static class OrderByCodeAndInvoiceNr implements Comparator<JsonTrorOrderLandImportInvoiceRecord> {
        @Override
        public int compare(JsonTrorOrderLandImportInvoiceRecord o1, JsonTrorOrderLandImportInvoiceRecord o2) {
