 ...
 *
 */
public class JsonTrorOrderFlyExportInvoiceRecord extends JsonAbstractGrandFatherRecord implements Comparable<JsonTrorOrderFlyExportInvoiceRecord>{
	 ...
	 */
	public int compareTo(JsonTrorOrderFlyExportInvoiceRecord record) {
		return 1;
	}
	/**
	 * 
	 ...
	 */
	public static class OrderByCodeAndInvoiceNr implements Comparator<JsonTrorOrderFlyExportInvoiceRecord> {
        @Override
        public int compare(JsonTrorOrderFlyExportInvoiceRecord o1, JsonTrorOrderFlyExportInvoiceRecord o2) {
