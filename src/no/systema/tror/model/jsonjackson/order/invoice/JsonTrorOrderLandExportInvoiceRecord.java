 ...
 *
 */
public class JsonTrorOrderLandExportInvoiceRecord extends JsonAbstractGrandFatherRecord implements Comparable<JsonTrorOrderLandExportInvoiceRecord>{
	 ...
	 */
	public int compareTo(JsonTrorOrderLandExportInvoiceRecord record) {
		return 1;
	}
	/**
	 * 
	 ...
	 */
	public static class OrderByCodeAndInvoiceNr implements Comparator<JsonTrorOrderLandExportInvoiceRecord> {
        @Override
        public int compare(JsonTrorOrderLandExportInvoiceRecord o1, JsonTrorOrderLandExportInvoiceRecord o2) {
