  ...
  function reloadCallerParentOrder(status, avd, opd) {
	  window.location = "tror_mainorderflyexport.do?action=doFetch&heavd=" + avd + "&heopd=" + opd + "&status=" + status;
  }
  ...
  jq(function() {
	...
	//produktkoder AIR
	  ...
	  jq('#trorSellerAddressesIdLink').click(function() {
		  ...
		  window.open('tror_mainorderflyexport_childwindow_seller_addresses.do?action=doFind&ctype=tror_seadr&kukun1=' + jq('#hekns').val(),"sellerAdrWin","top=300px,left=150px,height=600px,width=900px,scrollbars=no,status=no,location=no");
	  });
	  ...
	  jq('#trorBuyerAddressesIdLink').click(function() {
		  ...
		  window.open('tror_mainorderflyexport_childwindow_buyer_addresses.do?action=doFind&ctype=tror_byadr&kundnr=' + jq('#heknk').val(),"buyerAdrWin","top=300px,left=150px,height=600px,width=900px,scrollbars=no,status=no,location=no");
	  });
...
//==============================================================================
  ...
  jq(function() {
	    ...
	    jq('#dftollIdLink').click(function() {
	      	...
	      	window.open('tror_mainorder_childwindow_tollsted.do?action=doFind&ctype=flyexport&direction=fra', "tollstedWin", "top=300px,left=450px,height=500px,width=700px,scrollbars=no,status=no,location=no");
	      });
...
//-----------------------
  ...
  jq(function() {  
	    ...
	    function getConsignor(){
    		...
    		if(hekns!=null && hekns!=""){
	    		jq.getJSON('getCustomer_Flyexport.do', {
				applicationUser : jq('#applicationUser').val(),
				id : jq('#hekns').val(),
				ajax : 'true'
	    		}, function(data) {
  ...
  jq(function() {
	  jq('#heot').change(function() {
		  var id = jq('#heot').val();
		  if(id!=''){
			  jq.getJSON('getOppdragsTypeDocuments_Flyexport.do', {
				  applicationUser : jq('#applicationUser').val(),
				  id : id,
				  ajax : 'true'
			  }, function(data) {
