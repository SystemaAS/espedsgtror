...
//Global functions
  ...
  jq(function() {
	  ...
	  jq('#trorBuyerAddressesIdLink').click(function() {
		  ...
		  window.open('tror_mainorderflyimport_childwindow_buyer_addresses.do?action=doFind&ctype=tror_byadr_fb&kundnr=' + jq('#dfknsm').val(),"buyerAdrWin","top=300px,left=150px,height=600px,width=900px,scrollbars=no,status=no,location=no");
	  });
	  ...
	  jq('#trorSellerAddressesIdLink').click(function() {
		  ...
		  window.open('tror_mainorderflyimport_childwindow_buyer_addresses.do?action=doFind&ctype=tror_seadr_fb&kundnr=' + jq('#dfknss').val(),"buyerAdrWin","top=300px,left=150px,height=600px,width=900px,scrollbars=no,status=no,location=no");
	  });
	  ...
	  jq('#dftollIdLink').click(function() {
		  jq('#dftollIdLink').attr('target','_blank');
      	  window.open('tror_mainorder_childwindow_tollsted.do?action=doFind&ctype=flyimport_fb&direction=fra', "tollstedWin", "top=300px,left=450px,height=500px,width=700px,scrollbars=no,status=no,location=no");
	  });
	  ...
	  jq('#trorPostalCodePonrnIdLink').click(function() {
		  jq('#trorPostalCodePonrnIdLink').attr('target','_blank');
      	  window.open('tror_mainorder_childwindow_postalcodes_ponrn.do?action=doFind&ctype=flyimport_fb_dfpoul&ponnr=' + jq('#dfpoul').val() , "postalCodeWin", "top=300px,left=150px,height=600px,width=800px,scrollbars=no,status=no,location=no");
	  });
