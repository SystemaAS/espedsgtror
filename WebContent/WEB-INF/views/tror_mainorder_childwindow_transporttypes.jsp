				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%">
					...
					<table id="transporttypesList" class="display compact cell-border" width="100%">
						...
						<tr class="tableHeaderField" height="20">
							<th width="2%" align="center" class="text14">&nbsp;<spring:message code="systema.tror.childwindow.transporttypes.label.kode"/></th>   
		                    <th class="text14">&nbsp;<spring:message code="systema.tror.childwindow.transporttypes.label.name"/></th>
		                </tr> 
		                </thead>
